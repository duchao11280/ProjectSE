                                ...
                                <c:forEach var="c" items="${lstFood}">
                                    <div class="col-sm-4 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h6 class="card-title" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap">${c.foodName}</h6>
                                            ...
                                            <div class="card-footer bg-yellow">
                                                <a class="btn btn-sm btn-outline-primary"
                                                   href="${pageContext.request.contextPath}/Food/Detail?id=${c.foodID}"
                                                   role="button">
